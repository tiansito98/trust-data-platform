...
if df_fin.empty:
    ...
    # Export: EXACTAMENTE las columnas mostradas en la tabla (mismas etiquetas
    # y orden que el data_editor). Los montos ya vienen formateados como texto
    # con estilo europeo ($1.502.654 / TRM 2,00 / -).
